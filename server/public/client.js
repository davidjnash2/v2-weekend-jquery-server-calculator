...
function getOperator(event){ // start get operator function
  ...
  operator=$(this).text; // select value of this clicked button
...
function postMaths(event){ // start POST function
  ...
  .then(function(response) { // await response from server
...
function getMaths(){ // start getMaths function
  ...
  .then(function(response) { // call back response
...
function renderToDom(answers){ // start render function
  ...
  for (let answer of answers){
    $('#answer-area').append(`${answer.result}`);
    $('#past-math').append(`
